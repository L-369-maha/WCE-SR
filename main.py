...
"""
scale 8: --name EndoSR_withoutWL/endosr_x8 --adv_w 0.01 --wav_w 0 --scale 8 --batch_size 1 --patch_size_down 512 --decay_batch_size_sr 80000 --decay_batch_size_down 60000 --epochs_sr_start 51 --gpu cuda:3 --sr_model endosr --training_type endosr --joint --save_results --save_log
